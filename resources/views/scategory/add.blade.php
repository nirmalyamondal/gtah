                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('scategory.create') }}" id="scategory_form" novalidate>
                        @csrf
                           <div class="row">
                           ...
                           <div class="row">                                
                                 ...
                                 <div class="form-group col-md-6 col-lg-6">
                                    <input type="submit" class="btn btn-default pull-left" id="addScategoryBtn" name="addScategoryBtn" value="Add">
                                 </div>
                            </div>
                        </form>	
                     </div>
