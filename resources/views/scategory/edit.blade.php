...
<head>
  ...
  <style>    
                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('scategory.create') }}/{{$data['id']}}" id="scategory_form" novalidate>
                        @csrf
                        @method('PATCH')
                           <div class="row">
                           ...
                           <div class="row">
                                <div class="form-group col-md-4 col-lg-4">
                                 ...
                                 <div class="form-group col-md-4 col-lg-4">
                                    ...
                                    <select class="dropdown-toggle selectpicker btn-option2" id="aid" name="aid" style="text-align:left;">
                                       {!! $data['aidSlect'] !!}
                                    </select>
                                 </div>
                                 <div class="form-group col-md-4 col-lg-4">
                           ...
                           <div class="row">
                                 ...
                                 <div class="form-group col-md-6 col-lg-6">
                                    <input type="submit" class="btn btn-default pull-left" id="updateScategoryBtn" name="updateScategoryBtn" value="Update">
                                 </div>
                            </div>
                        </form>  
                     </div>
                        ...
                        <table id="example0" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example0_info">
                           <thead>
                              <tr role="row">
                                 ...
                                 <th id="default" class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Menu Category Name: activate to sort column ascending" style="width: 141px;">Subject</th>   
                                 <th id="default" class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Menu Category Name: activate to sort column ascending" style="width: 141px;">Category</th>
                                 <th id="default" class="sorting" tabindex="0" aria-controls="example0" rowspan="1" colspan="1" aria-label="Menu Category Name: activate to sort column ascending" style="width: 141px;">Assignment</th> 
                                 <th>Status</th>
                                 <th>&nbsp;</th>   
                                 <!--th>&nbsp;</th-->                           
                              </tr>
                           ...
                           <tbody>
                              ...
                              <tr id="tr{{ $val['id'] }}" role="row" class="">
                                 ...
                                 <td>
                                    <a href="{{ route('scategory.create') }}/{{ $val['id'] }}"><input type="button" class="btn btn-primary btnedit-delete" value="Edit" name="edit" id="edit"></a>
                                 </td>
                                 <!--td>
                                    <form method="POST" action="{{ route('scategory.create') }}/{{ $val['id'] }}" id="scategory_delete_form" enctype="multipart/form-data">
                                       @csrf
                                       @method('DELETE')
   ...
   <footer>
        ...
        <script src="{{ asset('public/js/module/scategory.js') }}"></script>
   </footer>
</html>