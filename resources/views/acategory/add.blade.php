                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('acategory.create') }}" id="acategory_form" novalidate>
                        @csrf
                           <div class="row">
                           ...
                           <div class="row">
                                <div class="form-group col-md-4 col-lg-4">
                                 ...
                                 <div class="form-group col-md-4 col-lg-4">
                                    <input type="submit" class="btn btn-default pull-left" id="addAcategoryBtn" name="addAcategoryBtn" value="Add">
                                 </div>
                            </div>
                        </form>	
                     </div>
