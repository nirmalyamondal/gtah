                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('qcategory.create') }}" id="qcategory_form" novalidate>
                        @csrf
                           <div class="row">
                           ...
                           <div class="row">
                                <div class="form-group col-md-6 col-lg-6">
                                    ...
                                    <input type="text" class="col-md-6 " id="name" name="name" value="" required="required">
                                 </div>
                                 <div class="form-group col-md-6 col-lg-6">
                                    <input type="submit" class="btn btn-default pull-left" id="addQcategoryBtn" name="addQcategoryBtn" value="Add">
                                 </div>
                            </div>
                        </form>	
                     </div>
                        ...
                        <table id="example0" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example0_info">
                           ...
                           <tbody>
                              ...
                              <tr id="tr{{ $val['id'] }}" role="row" class="">
                                 ...
                                 <td>
                                    <a href="{{ route('qcategory.create') }}/{{ $val['id'] }}"><input type="button" class="btn btn-primary btnedit-delete" value="Edit" name="edit" id="edit"></a>
                                 </td>
                                 <!--td>
                                    <form method="POST" action="{{ route('qcategory.create') }}/{{ $val['id'] }}" id="qcategory_delete_form" enctype="multipart/form-data">
                                       @csrf
                                       @method('DELETE')
