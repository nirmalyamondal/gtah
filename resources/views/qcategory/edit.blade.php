                    ...
                    <div class="panel-title">
                     ...
                     <div class="panel-body">
                       @if (session('status'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('qcategory.create') }}/{{$data['id']}}" id="qcategory_form" novalidate>
                        @csrf
                        @method('PATCH')
                           <div class="row">
                           ...
                           <div class="row">
                                <div class="form-group col-md-4 col-lg-4">
                                 ...
                                 <div class="form-group col-md-4 col-lg-4">
                                    <input type="submit" class="btn btn-default pull-left" id="updateQcategoryBtn" name="updateQcategoryBtn" value="Update">
                                 </div>
                            </div>
                        </form>  
                     </div>
